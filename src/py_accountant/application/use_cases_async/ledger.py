...
from py_accountant.domain.ledger import LedgerEntry, LedgerValidator
...
class AsyncPostTransaction:
    ...
    async def __call__(
        ...
        from py_accountant.domain.currencies import (  # local import to keep async module surface concise
            Currency,
        )
